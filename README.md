...
|---|---|
| [System Architecture](DashboardAnalyticsForJJ/docs/ARCHITECTURE.md) | Overall system design — tech stack, data pipeline, UI layout, module responsibilities |
| [AI Architecture](DashboardAnalyticsForJJ/docs/AI_ARCHITECTURE.md) | AI subsystem deep dive — LLM integration, LangGraph workflows, memory system, fallback strategy |
